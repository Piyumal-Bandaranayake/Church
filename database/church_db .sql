...
(7, 'admin2', 'admin@gmail.com', '$2y$10$NfrLwIbcHxy/baMjjudcpeAyYnQosuTE5qxneWFC6i9j70vdlxaSW', '2026-03-03 09:47:21');
...
--
-- Table structure for table `partner_found_reports`
--

CREATE TABLE `partner_found_reports` (
  `id` int(11) NOT NULL,
