...
if (isset($_GET['delete'])) {
    ...
    $stmt->execute([$id, $denomination_filter]);
    header("Location: approved_catholic.php?success=deleted");
    exit();
}
...
function renderTable($list) {
    if (empty($list)) {
        ...
        echo '<p class="text-gray-400 font-black uppercase tracking-widest text-[10px]">No approved Catholic members found</p>';
        echo '</div>';
        return;
    }
    ?>
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12">
                <div>
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <h1 class="text-4xl font-black text-gray-900 tracking-tighter">Catholic Members</h1>
                    </div>
                    <p class="text-gray-500 font-medium italic">Advanced filtering for active Catholic members.</p>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 mb-12">
                <form action="" method="GET" class="space-y-8">
                    ...
                    <div class="flex justify-end gap-3 pt-4">
                        <a href="approved_catholic.php" class="px-6 py-3 bg-gray-100 text-gray-500 rounded-2xl text-xs font-bold uppercase tracking-widest hover:bg-gray-200 transition-all">Clear</a>
