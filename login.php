        ...
        <div class="bg-white py-10 px-8 shadow-md rounded-2xl border border-gray-100">
            ...
            <form class="space-y-6" action="" method="POST">
                <div>
                    ...
                    <input id="login_id" name="login_id" type="text" required placeholder="Email or admin username" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
                </div>
                ...
                <button type="submit" class="w-full py-3.5 bg-primary text-white font-bold rounded-xl hover:bg-blue-900 shadow-lg shadow-blue-900/10 transition-all">
                    Sign in
                </button>
            </form>
