...
<div class="bg-primary pt-32 pb-28 text-center relative overflow-hidden">
    ...
    <div class="relative z-20 container mx-auto px-4 mt-8">
        <p class="text-blue-300 text-xs font-black uppercase tracking-[0.4em] mb-4 animate-fade-in">Holy Spirit Prayer Group</p>
...
<div class="py-24 themed-background">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-20 text-center reveal reveal-up">
            <div class="inline-block bg-white rounded-3xl shadow-xl border border-slate-100 px-12 py-10 max-w-2xl w-full">
                ...
                <p class="text-slate-500 font-medium mb-6">Reach out to us to join a session, request a home visit, or enrol in a course. We'd love to serve you.</p>
                <a href="contact.php" class="inline-flex items-center gap-2 px-8 py-4 bg-primary text-white font-bold rounded-2xl hover:bg-blue-900 transition-all shadow-lg shadow-primary/20 hover:-translate-y-0.5 transform">
                    Contact Us
