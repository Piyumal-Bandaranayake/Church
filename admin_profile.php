        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 p-8">
            ...
            <form method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="new_password" type="password" name="new_password" required class="w-full px-4 py-3 rounded-xl bg-gray-50 border-gray-100 focus:bg-white focus:ring-2 focus:ring-primary/20 outline-none transition-all pr-12">
